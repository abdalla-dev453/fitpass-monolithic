...
const FALLBACK_PLANS = [
  ...
  },
  {
    ...
    duration_days: 90,
    description:
      "THE ULTIMATE ALLOCATOR TIERS FOR CONSISTENT WORKOUT ROUTINES.",
    perks: [
      "10 CLASS CREDITS",
      "VALID 90 DAYS",
...
export default function Pricing() {
  ...
  const { purchasePlan, user, showToast } = useApp();
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 z-10">
            ...
            {plans.map((plan) => (
              ...
              >
                ...
                <div className="mt-8 pt-4">
                  ...
                  >
                    {user ? "ACTIVATE ACCOUNT PASS" : "LOG IN TO ACTIVATE PASS"}
                  </button>
                </div>
              </div>
            ))}
          ...
          <div className="mt-16 max-w-2xl mx-auto border border-zinc-800 bg-zinc-900/40 p-4 flex items-center gap-4">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-zinc-400 leading-normal">
              ALL UNUSED CREDIT ALLOCATIONS ARE AUTOMATICALLY REDEPLOYED BACK TO
              OPERATIONAL BALANCE STORAGE CAPS UPON SUBROUTE EXPIRED TERM RESET
              STAGES.
            </p>
          </div>
        </div>
